...
const Tickets: React.FC = () => {
  ...
  const handlePurchase = (e: React.FormEvent) => {
    ...
    const totalPrice = match.price[ticketType] * ticketQuantity;
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between">
                        <div className="mb-2 sm:mb-0">
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-4 mt-2">
                            ...
                            <div className="flex items-center text-white/70 mt-1 sm:mt-0">
                ...
                <form onSubmit={handlePurchase} className="space-y-6 bg-team-gray/50 border border-white/10 p-6 rounded-sm">
                  ...
                  <div>
                    ...
                    <select
                      id="ticket-type"
                      value={ticketType}
                      onChange={(e) => setTicketType(e.target.value as 'standard' | 'premium' | 'vip')}
                  ...
                  <div className="border-t border-white/10 pt-4">
                    <div className="flex justify-between text-white mb-2">
                      <span>Price:</span>
                      <span>${upcomingMatches[selectedMatch].price[ticketType]} x {ticketQuantity}</span>
                    </div>
                    <div className="flex justify-between text-white font-bold text-lg">
                      <span>Total:</span>
                      <span>${upcomingMatches[selectedMatch].price[ticketType] * ticketQuantity}</span>
                    </div>
                  </div>
